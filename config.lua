Config = {
  DevMode = false,
  Langs = "es",                        -- Set the language for your script (you can change this if you support multiple languages).
  ...
  EveryTimeStatusDown = 83600,          -- Time interval (in milliseconds) for status drop (3.6 seconds).
